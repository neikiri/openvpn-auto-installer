...
* 📧 Email: **[neikiri@neikiri.dev](mailto:neikiri@neikiri.dev)** *(replace this)*
...
* Steps to reproduce
* Affected system (Debian/Ubuntu version)
* Potential impact
...
Security issues related to these areas are considered **in-scope**.
